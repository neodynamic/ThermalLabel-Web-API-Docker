    ...
    var ClientPrintJob = (function (_super) {
        ...
        ClientPrintJob.prototype._genPFGArrayAsync = function (printFileGroup) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var zipped_files = printFileGroup.map(function (pf) {
                    return new Promise(function (ok, err) {
                ...
                Promise.all(zipped_files).then(function (_) {
                    return __awaiter(_this, void 0, void 0, function () {
                        var e_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
    ...
    var PrintFileGroup = (function (_super) {
        ...
        PrintFileGroup.prototype._getBLOBContent = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2, new Promise(function (ok, err) {
                        return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        zipped_files = this.fileContent.map(function (file) {
                                            return new Promise(function (resolve, reject) {
                                                return __awaiter(_this, void 0, void 0, function () {
